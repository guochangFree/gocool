package com.sigo.oa.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.sigo.oa.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\com\\guochang\\guns\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\guochang\\guns\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.sigo.oa.modular." + contextConfig.getModuleName() + ".service";
    }
