...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\src\\main\\java\\com\\sigo\\oa\\modular\\" + contextConfig.getModuleName() + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\com\\sigo\\oa\\modular\\" + contextConfig.getModuleName() + "\\dao\\mapping\\{}Dao.xml";
        this.packageName = "com.sigo.oa.modular." + contextConfig.getModuleName() + ".dao";
    }
