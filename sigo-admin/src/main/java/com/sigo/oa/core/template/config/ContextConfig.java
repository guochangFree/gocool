...
public class ContextConfig {
    ...
    private String modelPackageName = "com.sigo.oa.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.sigo.oa.common.persistence.dao";  //model的dao
